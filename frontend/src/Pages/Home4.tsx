...
const Home4: React.FC = () => {
  useEffect(() => {
    document.title = "Home Modern | Mojuri";
    document.body.className = "home home-4 title-4";
    return () => {
  ...
  return (
    <>
      <div id="page" className="hfeed page-wrapper">
								...
								<div className="block block-sliders layout-4 auto-height color-white nav-center">
									<div className="slick-sliders" data-autoplay="true" data-dots="true" data-nav="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns1440="1" data-columns="1">
										<div className="item slick-slide">
											<div className="item-content">
												<div className="content-image">
													<img width="1920" height="781" src="/media/slider/4-1.jpg" alt="Image Slider" />
												</div>
												<div className="item-info horizontal-center vertical-middle text-center">
													<div className="content">
														...
														<a className="button-slider button button-white button-outline thick-border" href="/shop-grid-left">Explore Bestseller</a>
													</div>
												</div>
											</div>
										</div>
										<div className="item slick-slide">
											<div className="item-content">
												<div className="content-image">
													<img width="1920" height="781" src="/media/slider/4-2.jpg" alt="Image Slider" />
												</div>
												<div className="item-info horizontal-center vertical-middle text-center">
													<div className="content">
										...
										<div className="item slick-slide">
											<div className="item-content">
												<div className="content-image">
													<img width="1920" height="781" src="/media/slider/4-3.jpg" alt="Image Slider" />
												</div>
												<div className="item-info horizontal-center vertical-middle text-center">
													<div className="content">
														...
														<div className="bg-banner">
															<div className="banner-wrapper banners">
																...
																<div className="banner-wrapper-infor">
																	<div className="info">
																		<div className="content">
																			<h3 className="title-banner">JOIN THE LAYERING GANG</h3>
																			<div className="banner-image-description">
							...
							<section className="section section-padding top-border p-t-70 m-b-70">
								<div className="section-container large">
									...
									<div className="block block-products slider">
										<div className="block-widget-wrap">
											<div className="block-title">
												<div className="sub-title">Discover This Week’s</div>
							...
							<section className="section m-b-70">
								...
								<div className="block block-video">
									...
									<div className="video-caption">
										...
										<a className="button button-white animation-horizontal" href="/shop-grid-left">DISCOVER NOW</a>
									</div>
								</div>
							</section>
												...
												<div className="section-column left">
													<div className="intro-wrap">
														...
														<div className="intro-btn">
															<a href="/shop-grid-left" className="button button-outline border-black animation-horizontal">Read more</a>
														</div>
													</div>
												</div>
			...
			<Footer className="site-footer four-columns no-border-top" />
		</div>
