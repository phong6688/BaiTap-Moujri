...
const ShopListRight: React.FC = () => {
  useEffect(() => {
    document.title = "Shop List - Right Sidebar | Mojuri";
  }, []);
									...
									<div className="row">
										<div className="col-xl-9 col-lg-9 col-md-12 col-12 products-column">
												...
												<div className="products-topbar-right">
													...
													<ul className="layout-toggle nav nav-tabs">
														<li className="nav-item">
															<a className="layout-grid nav-link" data-toggle="tab" href="#layout-grid" role="tab"><span className="icon-column"><span className="layer first"><span></span><span></span><span></span></span><span className="layer middle"><span></span><span></span><span></span></span><span className="layer last"><span></span><span></span><span></span></span></span></a>
														</li>
														<li className="nav-item">
															<a className="layout-list nav-link active" data-toggle="tab" href="#layout-list" role="tab"><span className="icon-column"><span className="layer first"><span></span><span></span></span><span className="layer middle"><span></span><span></span></span><span className="layer last"><span></span><span></span></span></span></a>
														</li>
													</ul>
												</div>
											</div>
											...
											<div className="tab-content">
												<div className="tab-pane fade" id="layout-grid" role="tabpanel">
