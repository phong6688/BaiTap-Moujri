...
const Home8: React.FC = () => {
  useEffect(() => {
    document.title = "Home Unique | Mojuri";
    document.body.className = "home home-8 title-8";
    return () => {
  ...
  return (
    <>
      <div id="page" className="hfeed page-wrapper">
			<Header className="site-header header-v3 small-padding" />
					...
					<div id="primary" className="content-area">
						<div id="content" className="site-content" role="main">
							<section className="section">
								...
								<div className="block block-sliders layout-5 auto-height nav-center">
									<div className="slick-sliders" data-autoplay="true" data-dots="true" data-nav="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns1440="1" data-columns="1">
										<div className="item slick-slide">
											<div className="item-content">
												<div className="content-image">
													<img src="/media/slider/8-1.jpg" alt="Image Slider" />
												</div>
												<div className="item-info horizontal-center vertical-middle text-center">
													<div className="content">
														<h2 className="title-slider">Jewelry For Every Day</h2>
														<a className="button-slider button button-outline border-black thick-border" href="/shop-grid-left">SHOP NOW</a>
													</div>
												</div>
											</div>
										</div>
										<div className="item slick-slide">
											<div className="item-content">
												<div className="content-image">
													<img src="/media/slider/8-2.jpg" alt="Image Slider" />
												</div>
												<div className="item-info horizontal-center vertical-middle text-center">
													<div className="content">
														<h2 className="title-slider">Discover the Best of the Best</h2>
														<a className="button-slider button button-outline border-black thick-border" href="/shop-grid-left">SHOP NOW</a>
													</div>
												</div>
											</div>
										...
										<div className="item slick-slide">
											<div className="item-content">
												<div className="content-image">
													<img src="/media/slider/8-3.jpg" alt="Image Slider" />
												</div>
												<div className="item-info horizontal-center vertical-middle text-center">
													<div className="content">
							...
							<section className="section section-padding m-b-70">
								<div className="section-container">
									...
									<div className="block block-product-cats layout-5">
											...
											<div className="row">
														...
														<div className="item-product-cat-content">
															<a href="/shop-grid-left">
																<div className="item-image animation-horizontal">
																	<img src="/media/product/cat-8-1.jpg" alt="Shop Rings" />
																</div>
															</a>
												...
												<div className="section-column center sm-m-b">
													<div className="section-column-inner">
														<div className="row">
															<div className="section-column full m-b-15">
																<div className="item item-product-cat">	
																	<div className="item-product-cat-content">
																		<a href="/shop-grid-left">
																			<div className="item-image animation-horizontal">
																				<img src="/media/product/cat-8-2.jpg" alt="Shop Bracelets" />
																			</div>
																		</a>
																		<div className="product-cat-content-info">
																			<h2 className="item-title">
														...
														<div className="row">
															<div className="section-column sm-m-b">
																<div className="item item-product-cat">	
																	<div className="item-product-cat-content">
																		<a href="/shop-grid-left">
																			<div className="item-image animation-horizontal">
																				<img src="/media/product/cat-8-3.jpg" alt="Shop Necklaces" />
																			</div>
																		</a>
																		<div className="product-cat-content-info">
																			<h2 className="item-title">
															...
															<div className="section-column">
																<div className="item item-product-cat">	
																	<div className="item-product-cat-content">
																		<a href="/shop-grid-left">
																			<div className="item-image animation-horizontal">
																				<img src="/media/product/cat-8-4.jpg" alt="Shop Earrings" />
																			</div>
																		</a>
																		<div className="product-cat-content-info">
																			<h2 className="item-title">
														...
														<div className="item-product-cat-content">
															<a href="/shop-grid-left">
																<div className="item-image">
																	<img src="/media/product/cat-8-5.jpg" alt="Shop Charm" />
																</div>
															</a>
															<div className="product-cat-content-info">
																<h2 className="item-title">
							...
							<section className="section section-padding m-b-70">
								<div className="section-container large">
									...
									<div className="block block-products slider">
										<div className="block-widget-wrap">
											<div className="block-title"><h2>Everyday Elegance</h2></div>
							...
							<section className="section section-padding background-img bg-img-6 p-t-70 p-b-50 m-b-70">
										...
										<div className="block-widget-wrap">
											<ul className="nav nav-tabs">
												<li className="nav-item">
													<a className="nav-link active" data-toggle="tab" href="#beauty-ingenuity" role="tab">Beauty & Ingenuity</a>
												</li>
												<li className="nav-item">
													<a className="nav-link" data-toggle="tab" href="#ear-stack" role="tab">Ear Stack Magic</a>
												</li>
												<li className="nav-item">
													<a className="nav-link" data-toggle="tab" href="#wristwear-essentials" role="tab">Wristwear Essentials</a>
												</li>
											</ul>
											<div className="tab-content">
													...
													<div className="row">
														<div className="section-column left">
															<div className="intro-wrap">
																<h2 className="intro-title">Beauty & Ingenuity</h2>
																...
																<div className="intro-btn">
																	<a href="/shop-grid-left" className="button button-outline border-black thick-border animation-horizontal hover-opacity">Shop Now</a>
																</div>
															</div>
														</div>
														<div className="section-column right">
															<img className="animation-horizontal" width="439" height="414" src="/media/banner/intro-5.png" alt="intro" />
														</div>
													</div>
												</div>
												<div className="tab-pane fade" id="ear-stack" role="tabpanel">
													<div className="row">
														<div className="section-column left">
															<div className="intro-wrap">
																<h2 className="intro-title">Ear Stack Magic</h2>
																<div className="intro-item">
																...
																<div className="intro-btn">
																	<a href="/shop-grid-left" className="button button-outline border-black thick-border animation-horizontal hover-opacity">Learn More</a>
																</div>
															</div>
														</div>
														<div className="section-column right">
												...
												<div className="tab-pane fade" id="wristwear-essentials" role="tabpanel">
													<div className="row">
														<div className="section-column left">
															<div className="intro-wrap">
																<h2 className="intro-title">Wristwear Essentials</h2>
																<div className="intro-item">
																	Nunc interdum lacus sit amet orci. Vestibulum turpis sem, aliquet eget, lobortis pellentesque, rutrum eu, nisl. Phasellus magna. Vestibulum facilisis, purus nec pulvinar iaculis, ligula mi congue nunc, vitae euismod ligula urna in dolor. Cras sagittis.
																</div>
																<div className="intro-btn">
														...
														<div className="post-grid post">	
															<div className="post-inner">
																<div className="post-image">
																	...
																	<a className="post-thumbnail" href="/blog-details-right">
																...
																<div className="post-content">
																	...
																	<div className="btn-read-more">
																		<a className="read-more btn-underline" href="/blog-details-right">Read more</a>
																	</div>
																</div>
															</div>
														</div>
			...
			<Footer className="site-footer four-columns" />
		</div>
