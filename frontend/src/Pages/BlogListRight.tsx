...
const BlogListRight: React.FC = () => {
  useEffect(() => {
    document.title = "Blog List - Right Sidebar | Mojuri";
  }, []);
											...
											<div className="posts-list list">
												<div className="post-entry post-wapper">
													...
													<div className="post-content">
														...
														<div className="post-btn">
															<a className="button button-outline border-black" href="/blog-details-right">Read more</a>
														</div>
													</div>
												</div>
												<div className="post-entry post-wapper">
													...
													<div className="post-content">
														...
														<div className="post-meta">
															<span className="post-categories"><i className="icon_folder-alt"></i> <a href="/blog-grid-right">Wedding & Bridal</a></span>
															<span className="post-time"><i className="icon_clock_alt"></i> August 16, 2023</span>
															<span className="post-comment"><i className="icon_comment_alt"></i> 4 Comments</span>				
														</div>
														<div className="post-excerpt">
															 Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. Aenean commodo ligula eget dolor. Nulla facilisi. Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. non, velit. Etiam rhoncus. Nunc interdum lacus sit amet orci.... 
														</div>
												...
												<div className="post-entry post-wapper">
													...
													<div className="post-content">
														...
														<div className="post-meta">
															<span className="post-categories"><i className="icon_folder-alt"></i> <a href="/blog-grid-right">Wedding & Bridal</a></span>
															<span className="post-time"><i className="icon_clock_alt"></i> October 04, 2023</span>
															<span className="post-comment"><i className="icon_comment_alt"></i> 3 Comments</span>															
														</div>
														<div className="post-excerpt">
															 Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. Aenean commodo ligula eget dolor. Nulla facilisi. Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. non, velit. Etiam rhoncus. Nunc interdum lacus sit amet orci.... 
														</div>
												...
												<div className="post-entry post-wapper">
													...
													<div className="post-content">
														...
														<div className="post-meta">
															<span className="post-categories"><i className="icon_folder-alt"></i> <a href="/blog-grid-right">Wedding & Bridal</a></span>
															<span className="post-time"><i className="icon_clock_alt"></i> October 20, 2023</span>
															<span className="post-comment"><i className="icon_comment_alt"></i> 1 Comment</span>															
														</div>
														<div className="post-excerpt">
															 Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. Aenean commodo ligula eget dolor. Nulla facilisi. Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. non, velit. Etiam rhoncus. Nunc interdum lacus sit amet orci.... 
												...
												<div className="post-entry post-wapper">
													...
													<div className="post-content">
														...
														<div className="post-meta">
															<span className="post-categories"><i className="icon_folder-alt"></i> <a href="/blog-grid-right">Wedding & Bridal</a></span>
															<span className="post-time"><i className="icon_clock_alt"></i> December 11, 2023</span>
															<span className="post-comment"><i className="icon_comment_alt"></i> 5 Comments</span>															
														</div>
														<div className="post-excerpt">
															 Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. Aenean commodo ligula eget dolor. Nulla facilisi. Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. non, velit. Etiam rhoncus. Nunc interdum lacus sit amet orci.... 
														</div>
